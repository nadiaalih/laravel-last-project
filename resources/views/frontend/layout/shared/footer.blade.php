                        ...
                        <div class="block text">
                            <div class="block-content">
                                <a href="index.html" class="logo-footer">
                                    <img src="{{('frontend/img/logo-2.png')}}" alt="Logo">
                                </a>
                            ...
                            <div class="block-content">
                                <div class="row margin-0">
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
                                        <a href="#">
                                            <img src="{{('frontend/img/instagram-1.png')}}" alt="Instagram Image">
                                        </a>
                                    </div>
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
                                        <a href="#">
                                            <img src="{{('frontend/img/instagram-2.png')}}" alt="Instagram Image">
                                        </a>
                                    </div>
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
                                        <a href="#">
                                            <img src="{{('frontend/img/instagram-3.png')}}" alt="Instagram Image">
                                        </a>
                                    </div>
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
                                        <a href="#">
                                            <img src="{{('frontend/img/instagram-4.png')}}" alt="Instagram Image">
                                        </a>
                                    </div>
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
                                        <a href="#">
                                            <img src="{{('frontend/img/instagram-5.png')}}" alt="Instagram Image">
                                        </a>
                                    </div>
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
                                        <a href="#">
                                            <img src="{{('frontend/img/instagram-6.png')}}" alt="Instagram Image">
                                        </a>
                                    </div>
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
                                        <a href="#">
                                            <img src="{{('frontend/img/instagram-7.png')}}" alt="Instagram Image">
                                        </a>
                                    </div>
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-0">
                                        <a href="#">
                                            <img src="{{('frontend/img/instagram-8.png')}}" alt="Instagram Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="item d-flex">
                                <div class="item-left">
                                    <img src="{{('frontend/img/home1-payment-1.png')}}" alt="Payment Intro">
                                </div>
                                <div class="item-right">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="item d-flex">
                                <div class="item-left">
                                    <img src="{{('frontend/img/home1-payment-2.png')}}" alt="Payment Intro">
                                </div>
                                <div class="item-right">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="item d-flex">
                                <div class="item-left">
                                    <img src="{{('frontend/img/home1-payment-3.png')}}" alt="Payment Intro">
                                </div>
                                <div class="item-right">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 align-right">
                    <div class="payment">
                        ...
                        <img src="{{('frontend/img/payment.png')}}" alt="Payment">
                    </div>
                </div>
            </div>
        </div>
